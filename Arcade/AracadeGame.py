...
def checksunhits():
    global sun
    melting_text = canvas.create_text(-100,-50, text='MELTING -1',fill='red',font=('Helvetica',20))
    if collision(icarussprite,sun,150):
        melting_text = canvas.create_text(100,50, text='MELTING -1',fill='red',font=('Helvetica',20))
        updatelives()
    melting_text= canvas.create_text(-100,-50, text='MELTING -1',fill='red',font=('Helvetica',20))

    window.after(1000,checksunhits)
